...
$convert -density 512 -resize 512x512 -extent 720x1280 "$1" "www/res/screen/android/screen-xhdpi-portrait.png"
$convert -density 256 -resize 256x256 -extent 320x480 "$1" "www/res/screen/android/screen-mdpi-portrait.png"
$convert -density 256 -resize 256x256 -extent 480x320 "$1" "www/res/screen/android/screen-mdpi-landscape.png"
$convert -density 128 -resize 128x128 -extent 200x320 "$1" "www/res/screen/android/screen-ldpi-portrait.png"
$convert -density 256 -resize 256x256 -extent 800x480 "$1" "www/res/screen/android/screen-hdpi-landscape.png"
$convert -density 256 -resize 256x256 -extent 480x800 "$1" "www/res/screen/bada/screen-portrait.png"
$convert -density 128 -resize 128x128 -extent 320x480 "$1" "www/res/screen/bada-wac/screen-type3.png"
$convert -density 256 -resize 256x256 -extent 480x800 "$1" "www/res/screen/bada-wac/screen-type4.png"
$convert -density 128 -resize 128x128 -extent 240x400 "$1" "www/res/screen/bada-wac/screen-type5.png"
$convert -density 256 -resize 256x256 -extent 480x800 "$1" "www/res/screen/bada-wac/screen-type5.png"
$convert -density 128 -resize 128x128 -extent 225x225 "$1" "www/res/screen/blackberry/screen-225.png"
$convert -density 256 -resize 256x256 -extent 320x480 "$1" "www/res/screen/ios/screen-iphone-portrait.png"
$convert -density 256 -resize 256x256 -extent 960x640 "$1" "www/res/screen/ios/screen-iphone-landscape-2x.png"
$convert -density 256 -resize 256x256 -extent 480x320 "$1" "www/res/screen/ios/screen-iphone-landscape.png"
$convert -density 512 -resize 512x512 -extent 768x1004 "$1" "www/res/screen/ios/screen-ipad-portrait.png"
$convert -density 1024 -resize 1024x1024 -extent 1536x2008 "$1" "www/res/screen/ios/screen-ipad-portrait-2x.png"
$convert -density 512 -resize 512x512 -extent 1024x783 "$1" "www/res/screen/ios/screen-ipad-landscape.png"
$convert -density 256 -resize 256x256 -extent 640x960 "$1" "www/res/screen/ios/screen-iphone-portrait-2x.png"
$convert -density 1024 -resize 1024x1024 -extent 2008x1536 "$1" "www/res/screen/ios/screen-ipad-landscape-2x.png"
$convert -density 64 -resize 64x64 "$1" "www/res/screen/webos/screen-64.png"
$convert -density 256 -resize 256x256 -extent 480x800 "$1" "www/res/screen/windows-phone/screen-portrait.jpg"
