...
$convert -resize 48x48 "$1" "www/res/icon/android/icon-48-mdpi.png"
$convert -resize 96x96 "$1" "www/res/icon/android/icon-96-xhdpi.png"
$convert -resize 128x128 "$1" "www/res/icon/bada/icon-128.png"
$convert -resize 48x48 "$1" "www/res/icon/bada-wac/icon-48-type5.png"
$convert -resize 80x80 "$1" "www/res/icon/bada-wac/icon-80-type4.png"
$convert -resize 50x50 "$1" "www/res/icon/bada-wac/icon-50-type3.png"
$convert -resize 80x80 "$1" "www/res/icon/blackberry/icon-80.png"
$convert -resize 29x29 "$1" "www/res/icon/ios/icon-29.png"
$convert -resize 40x40 "$1" "www/res/icon/ios/icon-40.png"
$convert -resize 50x50 "$1" "www/res/icon/ios/icon-50.png"
$convert -resize 57x57 "$1" "www/res/icon/ios/icon-57.png"
$convert -resize 58x58 "$1" "www/res/icon/ios/icon-58.png"
$convert -resize 72x72 "$1" "www/res/icon/ios/icon-72.png"
$convert -resize 76x76 "$1" "www/res/icon/ios/icon-76.png"
$convert -resize 80x80 "$1" "www/res/icon/ios/icon-80.png"
$convert -resize 100x100 "$1" "www/res/icon/ios/icon-100.png"
$convert -resize 144x144 "$1" "www/res/icon/ios/icon-144.png"
$convert -resize 114x114 "$1" "www/res/icon/ios/icon-114.png"
$convert -resize 120x120 "$1" "www/res/icon/ios/icon-120.png"
$convert -resize 152x152 "$1" "www/res/icon/ios/icon-152.png"
$convert -resize 64x64 "$1" "www/res/icon/webos/icon-64.png"
$convert -resize 48x48 "$1" "www/res/icon/windows-phone/icon-48.png"
$convert -resize 173x173 "$1" "www/res/icon/windows-phone/icon-173-tile.png"
$convert -resize 62x62 "$1" "www/res/icon/windows-phone/icon-62-tile.png"

convert="convert -background #101D38"
$convert -resize 128x128 "$1" "www/icon.png"
$convert -resize 170x200 "$1" "www/img/logo.png"
